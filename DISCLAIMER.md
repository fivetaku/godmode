# Disclaimer & Acceptable Use — godmode

`godmode` is a standalone plugin by the author of
...
`godmode` is a general-purpose developer tool. Like most general-purpose tools, it
